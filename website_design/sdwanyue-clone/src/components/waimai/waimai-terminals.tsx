 ...
 * [OUTPUT]: 多终端支持区块组件
 * [POS]: waimai 组件库的终端支持展示
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 */

const terminals = [
  { icon: "👤", title: "用户端", desc: "APP/小程序" },
  { icon: "🏪", title: "商家端", desc: "APP/小程序" },
  { icon: "🛵", title: "骑手端", desc: "APP/小程序" },
  { icon: "💻", title: "后台Web端", desc: "总后台/区域后台" },
];

export function WaimaiTerminals() {
  return (
